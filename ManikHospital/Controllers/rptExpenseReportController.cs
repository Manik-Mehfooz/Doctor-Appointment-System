...
{
    public class rptExpenseReportController : Controller
    {
        clsRptExpense exp = new clsRptExpense();
        ...
        //    string pathh = Path.Combine(Server.MapPath("~/Reports"), "rptExpenses.rdlc");
        ...
        //    Response.AddHeader("content-disposition", "attachment; filename=ExpensesReport.pdf");
        ...
        public ActionResult Print(clsSalesReport obj, FormCollection frm)
        {
            ...
            List<clsRptExpense> allCustomer = new List<clsRptExpense>();

            //ViewBag.List = exp.ExpensesReport();
            allCustomer = exp.ExpensesReport();

            ReportDocument rd = new ReportDocument();
            rd.Load(Path.Combine(Server.MapPath("~/CrystalReports/"), "rptExpenses.rpt"));
            ...
            datetime = dt + "_" + time;
            string pdffilename = datetime.ToString() + "_Monthly Expenses Report" + ".pdf";
