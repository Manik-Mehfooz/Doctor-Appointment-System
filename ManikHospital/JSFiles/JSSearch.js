...
app.controller("ctrlSearch", function ($scope, $http, $modal, $log) {
    ...
    $scope.GetCtrlAssetTypeData = function () {
        $scope.CheckSH = true;
        $http({
            method: "get",
            url: "../Search/GetCtrlAssetTypeData"
        }).then(function (response) {
            $scope.alldata = response.data;
            $scope.CheckSH = false;
    ...
    $scope.GetCtrlAssetData = function () {
        $scope.CheckSH = true;
        $http({
            method: "get",
            url: "../Search/GetCtrlAssetData"
        }).then(function (response) {
            $scope.alldata = response.data;
            $scope.CheckSH = false;
    ...
    $scope.GetCtrlAssetInventoryData = function () {
        $scope.CheckSH = true;
        $http({
            method: "get",
            url: "../Search/GetCtrlAssetInventoryData"
        }).then(function (response) {
            $scope.alldata = response.data;
            $scope.CheckSH = false;
    ...
    $scope.GetCtrlDoctorsData = function () {
        $scope.CheckSH = true;
        $http({
            method: "get",
            url: "../Search/GetCtrlDoctorsData"
        }).then(function (response) {
            $scope.alldata = response.data;
            $scope.CheckSH = false;
    ...
    $scope.GetCtrlStaffData = function () {
        $scope.CheckSH = true;
        $http({
            method: "get",
            url: "../Search/GetCtrlStaffData"
        }).then(function (response) {
            $scope.alldata = response.data;
            $scope.CheckSH = false;
    ...
    $scope.GetCtrlOrganizationData = function () {
        $scope.CheckSH = true;
        $http({
            method: "get",
            url: "../Search/GetCtrlOrganizationData"
        }).then(function (response) {
            $scope.alldata = response.data;
            $scope.CheckSH = false;
    ...
    $scope.SearchOldOPDTokenForReprint = function () {
        $scope.CheckSH = true;

        $http({
            method: "get",
            url: "SearchOldOPDTokenForReprint"
        }).then(function (response) {
            $scope.alldata = response.data;
            $scope.CheckSH = false;
            $scope.range = function () {
    ...
    $scope.GetCtrlNICUPatientData = function () {
        $scope.CheckSH = true;
        $http({
            method: "get",
            url: "../Search/GetCtrlNICUPatientData"
        }).then(function (response) {
            $scope.alldata = response.data;
            $scope.CheckSH = false;
    ...
    $scope.GetCtrlLaparoscopicPatientData = function () {
        $scope.CheckSH = true;
        $http({
            method: "get",
            url: "../Search/GetCtrlLaparoscopicPatientData"
        }).then(function (response) {
            $scope.alldata = response.data;
            $scope.CheckSH = false;
    ...
    $scope.GetCtrlRoleFormAssignData = function () {
        $scope.CheckSH = true;
        $http({
            method: "get",
            url: "../Search/GetCtrlRoleFormAssignData"
        }).then(function (response) {
            $scope.alldata = response.data;
            $scope.CheckSH = false;
